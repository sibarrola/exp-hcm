...
const FormularioMotivos = () => {
    ...
    const createMotivo = async motivo => {
        try {
            await axios.post('http://localhost:3000/api/motivos', motivo);
    ...
    const updateMotivo = async motivo => {
        try {
            await axios.put(`http://localhost:3000/api/motivos/${motivo._id}`, motivo);
    ...
    const deleteMotivo = async id => {
        await axios.delete(`http://localhost:3000/api/motivos/${id}`);
            ...
            <Box sx={{m:'30px',textAlign:'right' }}>
                ...
                >
                    ...
                    <DialogActions>
                        ...
                        <Button onClick={handleDialogConfirm}>Guardar</Button>
                    </DialogActions>
                </Dialog>
            </Container>
        </>
